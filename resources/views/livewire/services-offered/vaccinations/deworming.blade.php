<div>
    ...
    <div x-data="initData">
        <div class="mb-4">
            <div class="mb-4 ">
                <h2 class="text-2xl font-medium tracking-wide text-gray-800 dark:text-gray-100 ">Vaccinations</h2>
            </div>
        ...
        @include('livewire.services-offered.vaccinations.menu.nav')


        <div class="mb-5 ">
            <x-button @click="$wire.createModal = true"
                class="flex items-center gap-2 bg-primary-yellow hover:bg-primary-yellow-light">
                ...
                Create DW / HP / AM / ATF Record
            </x-button>
        </div>

        <livewire:tables.other-history-table />

        @include('livewire.services-offered.vaccinations.modal.deworming-modal')
