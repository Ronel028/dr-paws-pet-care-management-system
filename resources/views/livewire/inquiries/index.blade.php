<div>
    <div x-data="initData">
        <div class="mb-11">
            <div class="mb-4 ">
                <h2 class="text-2xl font-medium tracking-wide text-gray-800 dark:text-gray-100 ">Inquiries</h2>
            </div>
        ...
        <livewire:tables.inquiries-table />

        @include('livewire.inquiries.modal.modal')
