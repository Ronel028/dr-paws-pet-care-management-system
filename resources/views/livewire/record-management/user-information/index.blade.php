    ...
    <div x-data="initData">
            ...
            <nav class="flex mb-4" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    <li class="inline-flex items-center">
                        <a href="{{ route('record-management.index') }}"
        ...
        <div class="mb-5 ">
            <x-button @click="toggleShowModal"
                class="flex items-center gap-2 text-white bg-primary-yellow hover:bg-primary-yellow-light">
        ...
        @include('livewire.record-management.user-information.modal.modal')
