<div>
    ...
    <div x-data="initData">
        <div class="mb-11">
            <div class="mb-4 ">
                <h2 class="text-2xl font-medium tracking-wide text-gray-800 dark:text-gray-100 ">Pet Information</h2>
            </div>
            <nav class="flex mb-4" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    <li class="inline-flex items-center">
                        <a href="{{ route('record-management.pet-information') }}"
        ...
        <div class="mb-5 ">
            <x-button @click="toggleShowModal"
        ...
        <livewire:tables.pet-table />
        @include('livewire.record-management.pet-information.modal.modal')
