<div>
    ...
    <div x-data="initData">
        <div class="mb-4">
            <div class="mb-4 ">
                <h2 class="text-2xl font-medium tracking-wide text-gray-800 dark:text-gray-100 ">Appointments</h2>
            </div>
        ...
        @include('livewire.appointment-management.menu.nav')
        ...
        <livewire:tables.appointment-table />
        @include('livewire.appointment-management.modal.modal')
