<div>
    <div x-data="initData">
        <div class="mb-11">
            <div class=" mb-4">
                <h2 class="text-2xl font-medium tracking-wide text-gray-800 dark:text-gray-100 ">Pet Management</h2>
            </div>
        ...
        <div class="mb-5 ">
            <x-button @click="toggleShowModal"
                class=" bg-primary-yellow hover:bg-primary-yellow-light flex items-center gap-2">
        ...
        @include('livewire.pet-management.modal.modal')
