<div class="relative p-4 mb-8 overflow-hidden rounded-sm bg-gradient-to-tr from-primary-yellow-light to-primary-yellow dark:bg-gradient-to-tr dark:from-primary-blue dark:to-primary-blue-light sm:p-6">
